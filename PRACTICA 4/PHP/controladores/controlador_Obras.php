<?php
    ...
    if (isset($_POST['modifObra'])) {
    	...
    	$modeloObra->modificarObra($idM, $descripcionM, $tituloM, $imagenM, $fecha_publicacionM, $coleccionM);
    ...
    if(isset($_POST['aniadirObraConfirmar'])) {
        ...
        $modeloObra->aniadirObra($tituloNuevaObra, $coleccionNuevaObra, $ImagenNuevaObra, $descripcionNuevaObra);
